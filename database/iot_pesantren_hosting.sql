...
-- Import file ini melalui phpMyAdmin setelah memilih database hosting: arndilh2_monitoringpesantrenrm
-- CREATE DATABASE dan USE sengaja tidak dipakai agar cocok untuk shared hosting.
SET NAMES utf8mb4;
...
CREATE TABLE IF NOT EXISTS solar_monitoring (
    id INT AUTO_INCREMENT PRIMARY KEY,
    device_id INT,
    temperature FLOAT COMMENT 'Suhu panel surya DHT22 (Â°C)',
...
CREATE TABLE IF NOT EXISTS dryer_monitoring (
    id INT AUTO_INCREMENT PRIMARY KEY,
    device_id INT,
    temperature FLOAT COMMENT 'Suhu rumah pengering DHT22 (Â°C)',
    humidity FLOAT COMMENT 'Kelembaban DHT22 (%)',
...
('DHT22 Panel Surya', 'DHT22', 'Â°C', 'Panel Surya', 2),
('PZEM-017 Baterai', 'PZEM-017', 'V/A', 'Panel Surya', 2),
('DHT22 Rumah Pengering', 'DHT22', 'Â°C', 'Rumah Pengering', 3),
...
BEGIN
    ...
    WHILE i < 200 DO
        ...
        -- Solar data (suhu 25-75Â°C, kelembaban 30-80%, tegangan 10-14V, arus 0.5-5A)
        ...
        -- Dryer data (suhu 30-60Â°C, kelembaban 20-70%, AC 210-230V, arus 0.1-3A)
